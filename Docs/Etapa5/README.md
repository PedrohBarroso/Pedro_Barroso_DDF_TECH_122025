# Etapa 5: Processamento de Dados com GenAI e LLMs

> **Contexto & Estratégia:** Conforme os requisitos desta etapa, que solicita a capacidade de transformar dados desestruturados em features utilizando IA, optei por uma **implementação integrada**. Em vez de processar o dataset genérico de produtos sugerido, apliquei as técnicas de Engenharia de Prompts e extração de insights diretamente no domínio de negócio do projeto principal (**Yellow Taxi NYC**).
...
Para visualizar a aplicação prática desta competência, acesse a documentação detalhada e o código no link abaixo:

👉 **[Relatório Detalhado: Módulo de Market Intelligence (GenAI)](../EtapaBonus/README.md)**